...
class Attendance:
    ...
    def __init__(self,root):
        ...
        #create table 
        self.attendanceReport_left = ttk.Treeview(table_frame,column=("ID","Time","Date","Attend"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
        ...
        #create table 
        self.attendanceReport = ttk.Treeview(table_frame,column=("ID","Time","Date","Attend"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
